...
\textcolor {red} {
The probability of an application from Google App Store would turn off the Verify security feature is `r pnorm(-3.7)`.
}
...
\textcolor {red} {
With approx. 2.2 million apps out there, we can expect `r 2200000 * pnorm(-3.7)` apps would maliciously turn off the Verify feature once installed.
}
...
sample_t_sderr <- sd(sample_t) / (length(sample_t)^0.5)
