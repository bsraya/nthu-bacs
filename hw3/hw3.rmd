...
visualize_sample_ci <- function(num_samples = 100, sample_size = 100, 
                                pop_size=10000, title, distr_func=rnorm, ...) {
...
ci_95 <- function(num_samples = 100, sample_size = 100, 
...
ci_99 <- function(num_samples = 100, sample_size = 100, 
                                pop_size=10000, distr_func=rnorm, ...) {
  # Simulate a large population
  population_data <- distr_func(pop_size, ...)
  pop_mean <- mean(population_data)
...
visualize_sample_ci(num_samples = 100, sample_size = 100, pop_size=10000, 
                      distr_func=rnorm, mean=20, sd=3, title="Sample Size = 100")
visualize_sample_ci(num_samples = 100, sample_size = 300, pop_size=10000, 
                      distr_func=rnorm, mean=20, sd=3, title="Sample Size = 300")
```
As we can see from those two plots above, it becomes narrower when the sample size increases.
