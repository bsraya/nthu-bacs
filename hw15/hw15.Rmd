...
legend(
  6,
  8,
  c("True Eigenvalues", "Perturbed Eigenvalues"),
  lty=c(1,1),
  col = c("black", "red")
)
```
...
\textcolor{red}{Yes. When we decreased} `nfactors` \textcolor{red}{by 1, the number of questions belong to `RC1` would increase.}
